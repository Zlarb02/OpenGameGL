...
export interface TPSLayerConfig {
...
export class TPSLayer implements IAnimationLayer {
  ...
  private tpsConfig: TPSLayerConfig;
  private loader: FBXLoader;
  private spineBone: Bone | null = null;

  constructor(config?: TPSLayerConfig) {
    this.tpsConfig = {
  ...
  private async loadTPSAnimations(): Promise<void> {
    ...
    const loadAnim = async (
      ...
      try {
        ...
        console.warn(`[TPSLayer] Failed to load ${stateName}:`, error);
      }
    };
