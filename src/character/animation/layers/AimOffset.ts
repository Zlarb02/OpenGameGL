...
/**
 * AimOffset - Procedural layer that adjusts spine rotation based on camera pitch
 * This layer doesn't use animation clips, it directly manipulates bones
 */
export class AimOffset implements IAnimationLayer {
  ...
  async initialize(): Promise<void> {
    console.log('[AimOffset] Initialized (procedural layer, no clips)');
  }
  ...
  setSpineBone(bone: Bone): void {
    this.spineBone = bone;
    console.log('[AimOffset] Spine bone set');
  }
  ...
  disable(fadeOutDuration?: number): void {
    ...
    console.log('[AimOffset] Disabled');
  }
}
